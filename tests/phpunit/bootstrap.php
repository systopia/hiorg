...
// Make CRM_Hiorg_ExtensionUtil available.
require_once __DIR__ . '/../../hiorg.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('hiorg');
 ...
 */
function _hiorg_test_civicrm_container(ContainerBuilder $container): void {
}
